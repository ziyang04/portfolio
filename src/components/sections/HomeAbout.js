            ...
            <div className="introduction-container">
              <p className="introduction-text">
                ...
                <span className="intro-extended-content">
                  Over the past 3 years, I have completed 4 internships, most recently as a Full-Stack AI Engineer building agentic systems on Google Cloud Platform, and held additional leadership roles as Lead Webmaster of HKMSA and a Teaching Assistant for C++.
